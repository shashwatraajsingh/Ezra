...
const CLIENTS = [
    { name: "GitOps", icon: Hexagon },
    { name: "DevStack", icon: Triangle },
    { name: "Terminal", icon: Command },
    { name: "Phantom CI", icon: Ghost },
    { name: "RubyCore", icon: Gem },
    { name: "SiliconEng", icon: Cpu },
];
    ...
    return (
      ...
      */}
      ...
      `}</style>
            ...
            <div
                className="absolute inset-0 z-0 bg-[url(/image.png)] bg-cover bg-center opacity-40"
                style={{
                ...
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
                        ...
                        <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
                            Upload your resume, convert it to structured LaTeX, and
                            refine every line with AI — all synced live, precision-engineered for ATS.
                        </p>
                    ...
                    <div className="lg:col-span-5 space-y-6 lg:mt-12">
                        ...
                        <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <div>
                                        <div className="text-3xl font-bold tracking-tight text-white">45k+</div>
                                        <div className="text-sm text-zinc-400">Resumes Generated</div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3 mb-8">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-zinc-400">ATS Match Rate</span>
                                        <span className="text-white font-medium">96%</span>
                                    </div>
                                    <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                                        <div className="h-full w-[96%] rounded-full bg-gradient-to-r from-white to-zinc-400" />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    <StatItem value="LaTeX" label="Native" />
                                    <div className="w-px h-full bg-white/10 mx-auto" />
                                    <StatItem value="AI" label="Powered" />
                                    <div className="w-px h-full bg-white/10 mx-auto" />
                                    <StatItem value="Live" label="Preview" />
                                </div>
                        ...
                        <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
                            <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Used by Engineers Worldwide</h3>
